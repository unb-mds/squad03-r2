describe('FX', function() {
  ...
  describe('when animating styles', function() {
    it('should be possible to animate numeric styles', function () {
      ...
      rect.style('strokeWidth', startValue)
      fx.style('strokeWidth', endValue)

      fx.start()
      expect(rect.style('strokeWidth')).toBe(morph.at(0).toString())

      jasmine.clock().tick(250) // Have the animation be half way
      fx.step()
      expect(rect.style('strokeWidth')).toBe(morph.at(0.5).toString())

      jasmine.clock().tick(250) // Have the animation reach its end
      fx.step()
      expect(rect.style('strokeWidth')).toBe(morph.at(1).toString())
    })
    ...
    it('should allow 0 to be specified without a unit', function () {
      ...
      r1.style('strokeWidth', '100%').animate(500).style('strokeWidth', 0)
      r2.style('strokeWidth', 0).animate(500).style('strokeWidth', '100%')

      r1.fx.start()
      r2.fx.start()
      expect(r1.style('strokeWidth')).toBe('100%')
      expect(r2.style('strokeWidth')).toBe('0%')

      jasmine.clock().tick(250) // Have the animation be half way
      r1.fx.step()
      r2.fx.step()
      expect(r1.style('strokeWidth')).toBe('50%')
      expect(r2.style('strokeWidth')).toBe('50%')

      jasmine.clock().tick(250) // Have the animation reach its end
      r1.fx.step()
      r2.fx.step()
      expect(r1.style('strokeWidth')).toBe('0%')
      expect(r2.style('strokeWidth')).toBe('100%')
    })
  })
